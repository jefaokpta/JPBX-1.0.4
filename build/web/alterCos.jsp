...
<html>
    <head>
        <%
            ...
            out.print(head.header("JPBX->COS->Edit"));
    ...
    <body>
        ...
        <div id="container" class="container table-bordered">
            <form id="frm" name="frm1" action="AlterCos" method="POST">
                <fieldset>
                    <legend><h3>Nova Classe de Serviço</h3></legend>
                    <h4>Nome da Classe de Serviço</h4>
                    <div style="float: left">
                        <input id="cosName" type="text" name="cosName" value="<%=db.cosName(request.getParameter("grp")) %>" readonly="" />
                        <input type="hidden" name="idCos" value="<%=request.getParameter("grp") %>"/>
                    </div>
                    ...
                    <div class="table-bordered span3" style="height: 190px;overflow: scroll;float: left">
                        <ol id="costsAval">
                            <%
                              out.print(db.listCostsCos(request.getParameter("grp")));
                            %>
                        </ol>
                    </div>
                    ...
                    <div class="table-bordered span3" style="height: 190px;overflow: scroll;float: left;padding-left: 2%">
                        <ul id="costsSel"><%=db.listCosTypesSelected(request.getParameter("grp")) %></ul>
                    </div>
                    ...
                    <div class="table-bordered span3" style="height: 190px;overflow: scroll;float: left">
                        <ol id="peersAval">
                            <%
                              out.print(db.listPeersCos(request.getParameter("grp")));
                            %>
                        </ol>
                    </div>
                    <div style="float: left;padding-left: 2%">
                    ...
                    <div class="table-bordered span3" style="height: 190px;overflow: scroll;float: left;padding-left: 2%">
                        <ul id="peersSel"><%=db.listCosPeersSelected(request.getParameter("grp")) %></ul>
                    </div>
