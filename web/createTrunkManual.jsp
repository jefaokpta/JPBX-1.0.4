<%-- 
    Document   : createTrunkManual
    Created on : 08/10/2014, 16:19:49
    Author     : jefaokpta
--%>
...
<html>
    <head>
        ...
        out.print(head.header("JPBX->Manual->New"));
        %>
    </head>
    <body>
        <%=head.navigator(session.getAttribute("lvl").toString())%>
        <div id="container" class="container table-bordered">
          <form id="frm" action="CreateTrunks?chanTech=Manual" method="POST" name="form1">
            <fieldset>
                <legend><h2>Novo Tronco Manual</h2></legend>
                ...
                <input type="text" placeholder="Technology/Username" name="channel" id="channel" />
                <br>
