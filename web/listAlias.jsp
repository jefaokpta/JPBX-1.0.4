<%-- 
    Document   : listAlias
    Created on : 20/09/2014, 16:45:53
    Author     : jefaokpta
--%>
...
<html>
    <head>
        ...
        <%
            ...
            out.print(head.header("JPBX->Alias"));
    ...
    <body>
       ...
       <div id="container" class="container table-bordered">
        <h3>Alias de Expressões</h3>
        <div class="span1">
            <a rel="tooltip" data-placement="right" title="Criar novo Alias" href="createAlias.jsp"><img src="css/bootstrap/img/icon_new.png"></a>
        </div>
        <%
            JpbxDB db=new JpbxDB();
            out.print(db.listAlias());
        %>
    </div>
    <div id="alert"></div>
    </body>
