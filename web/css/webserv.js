function loadInternal(url,local)
{
    ...
    xmlhttp.onreadystatechange=function()
    {
		...
		{
            document.getElementById(local).innerHTML='<div style="font-family:verdana;font-weight:bold;font-size:12px;color:#666666;" align="center" valign="middle">Carregando p&aacute;gina&nbsp;&nbsp;<img src="css/bootstrap/img/loading.gif" /></div>';
		}
