 ...
 * @author jefaokpta
 */
public class AlterDialPlan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String alias=null,aliasCheck="0";
        int prio = 0,ruleOrder=0,ruleId=Integer.parseInt(request.getParameter("ruleid"));
        try{
            prio=Integer.parseInt(db.getLessDialPlanPriority(ruleId));
            ruleOrder=Integer.parseInt(db.getRuleOrder(ruleId));
        }catch(NumberFormatException ex){
            out.print("Ops!</br>"+ex.getMessage());
        }
        if(prio==0||ruleOrder==0) //verifica se td ocorreu bem
            out.print("Ops! Temos uma falha grave no sistema.</br>Por favor reporte ao suporte.");
        int aliasID=0;
        ...
        String alter=db.alterDialPlan(ruleId); //apaga todo este dialplan p ser reescrito
        if(!alter.equals("ok"))
            out.print("Ops!</br>"+alter);
        int qtdeApps=Integer.parseInt(request.getParameter("qtdeapps"));
        //int gotoIfFalse=Integer.parseInt(db.verifyGotoIf(request.getParameter("exten")));
        
        String fdb=null,exten=request.getParameter("exten"),
        ...
        if(request.getParameter("selsrc").equals("Ramal")&&request.getParameter("src").equals("Qualquer")) 
            if(request.getParameter("fulltime")!=null)
                fdb=db.createDialPlanRule(ruleId,request.getParameter("rulename"),"Ramal --> Todos",request.getParameter("exten"),1,ruleOrder,request.getParameter("selsrc"),request.getParameter("src"),aliasCheck,alias);
            else
                fdb=db.createDialPlanRule(ruleId,request.getParameter("rulename"),"Ramal --> Todos",request.getParameter("exten"),1,ruleOrder,request.getParameter("selsrc"),request.getParameter("src"),
            ...
            if(request.getParameter("fulltime")!=null)
                fdb=db.createDialPlanRule(ruleId,request.getParameter("rulename"),"Qualquer",request.getParameter("exten"),1,ruleOrder,request.getParameter("selsrc"),request.getParameter("src"),aliasCheck,alias);
            else
                fdb=db.createDialPlanRule(ruleId,request.getParameter("rulename"),"Qualquer",request.getParameter("exten"),1,ruleOrder,request.getParameter("selsrc"),request.getParameter("src"),
                        "0",request.getParameter("hstart"),request.getParameter("hend"),
                        seg,ter,qua,qui,sex,sab,dom,aliasCheck,alias);
        else if(request.getParameter("selsrc").equals("Fax"))
            if(request.getParameter("fulltime")!=null)
                fdb=db.createDialPlanRule(ruleId,request.getParameter("rulename"),"Fax Virtual",exten,1,ruleOrder,request.getParameter("selsrc"),request.getParameter("src"),aliasCheck,alias);
            else
                fdb=db.createDialPlanRule(ruleId,request.getParameter("rulename"),"Fax Virtual",exten,1,ruleOrder,request.getParameter("selsrc"),request.getParameter("src"),
                        "0",request.getParameter("hstart"),request.getParameter("hend"),
                        seg,ter,qua,qui,sex,sab,dom,aliasCheck,alias);
        else if(request.getParameter("selsrc").equals("Tronco"))
            if(request.getParameter("fulltime")!=null)
                fdb=db.createDialPlanRule(ruleId,request.getParameter("rulename"),"Tronco --> "+request.getParameter("src"),request.getParameter("exten"),1,ruleOrder,request.getParameter("selsrc"),request.getParameter("src"),aliasCheck,alias);
            else
                fdb=db.createDialPlanRule(ruleId,request.getParameter("rulename"),"Tronco --> "+request.getParameter("src"),request.getParameter("exten"),1,ruleOrder,request.getParameter("selsrc"),request.getParameter("src"),
                        "0",request.getParameter("hstart"),request.getParameter("hend"),
                        seg,ter,qua,qui,sex,sab,dom,aliasCheck,alias);
        else if(request.getParameter("selsrc").equals("Departamento"))
            if(request.getParameter("fulltime")!=null)
                fdb=db.createDialPlanRule(ruleId,request.getParameter("rulename"),"Departamento --> "+request.getParameter("src"),request.getParameter("exten"),1,ruleOrder,request.getParameter("selsrc"),request.getParameter("src"),aliasCheck,alias);
            else
                fdb=db.createDialPlanRule(ruleId,request.getParameter("rulename"),"Departamento --> "+request.getParameter("src"),request.getParameter("exten"),1,ruleOrder,request.getParameter("selsrc"),request.getParameter("src"),
                        "0",request.getParameter("hstart"),request.getParameter("hend"),
                        seg,ter,qua,qui,sex,sab,dom,aliasCheck,alias);
        else
            if(request.getParameter("fulltime")!=null)
                fdb=db.createDialPlanRule(ruleId,request.getParameter("rulename"),request.getParameter("src"),request.getParameter("exten"),1,ruleOrder,request.getParameter("selsrc"),request.getParameter("src"),aliasCheck,alias);
            else
                fdb=db.createDialPlanRule(ruleId,request.getParameter("rulename"),request.getParameter("src"),request.getParameter("exten"),1,ruleOrder,request.getParameter("selsrc"),request.getParameter("src"),
                        "0",request.getParameter("hstart"),request.getParameter("hend"),
                        seg,ter,qua,qui,sex,sab,dom,aliasCheck,alias);
        if(!fdb.equals("ok")){
        ...
        for(int i=1;i<=qtdeApps;i++){
            if(request.getParameter("appname"+i).equals("DialPeer")){ //Manipulando app Dial Ramal
                ...
                if(request.getParameter("param"+i).equals(""))
                    ...
                    param="dialPeer,"+request.getParameter("param"+i)+","+request.getParameter("paramaux"+i)+","+(request.getParameter("recall"+i)!=null?"1":"0");
