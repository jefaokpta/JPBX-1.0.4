 ...
 * @author jefaokpta
 */
public class AlterCallGrp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String fdb=null;
        fdb=db.deleteCallGrpMembers("callGrp&"+request.getParameter("grpName"));
        ...
        fdb=db.alterCallGrp(request.getParameter("grpName"), request.getParameter("timeout"), request.getParameter("strategy"),
